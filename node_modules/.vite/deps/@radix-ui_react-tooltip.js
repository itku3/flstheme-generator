...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React23.useRef(true);
  const isPointerInTransitRef = React23.useRef(false);
  ...
  return (0, import_jsx_runtime18.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React23.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React23.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
      ...
      onPointerInTransitChange: React23.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const wasOpenDelayedRef = React23.useRef(false);
  ...
  const stateAttribute = React23.useMemo(() => {
  ...
  return (0, import_jsx_runtime18.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime18.jsx)(
    TooltipContextProvider,
    {
      ...
      onTriggerEnter: React23.useCallback(() => {
...
var TooltipTrigger = React23.forwardRef(
  (props, forwardedRef) => {
    ...
    const handlePointerUp = React23.useCallback(() => isPointerDownRef.current = false, []);
    React23.useEffect(() => {
...
var TooltipContentHoverable = React23.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME2, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME2, props.__scopeTooltip);
  const ref = React23.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React23.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React23.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React23.useCallback(
    (event, hoverTarget) => {
...
var TooltipContentImpl = React23.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
...
var TooltipArrow = React23.forwardRef(
  (props, forwardedRef) => {
